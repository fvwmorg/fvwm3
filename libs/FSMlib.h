...
typedef enum
{
	FIceProtocolSetupSuccess,
	FIceProtocolSetupFailure,
	FIceProtocolSetupIOError,
...
#ifdef __STDC__
    FIceConn, FIcePointer, int, unsigned long, Bool, FIceReplyWaitInfo *, Bool *
#endif
);
...
typedef struct
{
	int		     major_version;
	int		     minor_version;
	FIcePoProcessMsgProc process_msg_proc;
} FIcePoVersionRec;
typedef struct
{
	int		     major_version;
	int		     minor_version;
	FIcePaProcessMsgProc process_msg_proc;
} FIcePaVersionRec;
typedef FIcePoAuthStatus (*FIcePoAuthProc)(
#ifdef __STDC__
    FIceConn, FIcePointer *, Bool, Bool, int, FIcePointer, int *, FIcePointer *,
    char **
#endif
);
typedef FIcePaAuthStatus (*FIcePaAuthProc)(
#ifdef __STDC__
    FIceConn, FIcePointer *, Bool, int, FIcePointer, int *, FIcePointer *,
    char **
#endif
);
...
#define FSmcRequestSaveYourself(a, b, c, d, e, f) \
	SmcRequestSaveYourself(a, b, c, d, e, f)
#define FSmcRequestSaveYourselfPhase2(a, b, c) \
	SmcRequestSaveYourselfPhase2(a, b, c)
