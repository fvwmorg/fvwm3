...
#define FShapeCombineRectangles(dpy, dst, dst_kind, xoff, yoff, rect, n_rects, \
    op, ordering)                                                              \
	XShapeCombineRectangles(dpy, dst, dst_kind, xoff, yoff, rect, n_rects, \
	    op, ordering)
...
#define FShapeQueryExtents(dpy, w, bounding_shaped, xb, yb, wb, hb, \
    clip_shaped, xclip, yclip, wclip, hclip)                        \
	XShapeQueryExtents(dpy, w, bounding_shaped, xb, yb, wb, hb, \
	    clip_shaped, xclip, yclip, wclip, hclip)
#define FShapeSelectInput(dpy, w, mask) XShapeSelectInput(dpy, w, mask)
#define FShapeInputSelected(dpy, w) XShapeInputSelected(dpy, w)
