 ...
 * </description>
 */
Bool PImageCreatePixmapFromArgbData(Display *dpy, Window win, CARD32 *data,
 ...
 * </description>
 */
FvwmPicture *PImageLoadFvwmPictureFromFile(Display *dpy, Window win, char *path,
    FvwmPictureAttributes fpa);
 ...
 * </description>
 */
Cursor PImageLoadCursorFromFile(Display *dpy, Window win, char *path, int x_hot,
    int y_hot);
 ...
 * </description>
 */
Bool PImageLoadPixmapFromXpmData(Display *dpy, Window win, int color_limit,
