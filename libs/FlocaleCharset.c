...
char *big5_0[]	    = { "BIG5", "big5", /* aix, hpux, osf */
	     "zh_TW-big5",		/* solaris 9? */
	     NULL };
char *big5hkscs_0[] = { "BIG5-HKSCS", "BIG5", "big5", /* aix, hpux, osf */
	"zh_TW-big5",				      /* solaris 9? */
	NULL };
char *cns11643[]    = { "EUCTW", "EUC-TW", "eucTW", "euc-tw", "euctw", NULL };
char *dosencoding_cp437[] = { "CP437", NULL };
char *dosencoding_cp850[] = { "CP850", "cp850", /* osf */
	"IBM-850",				/* aix */
	NULL };
char *gb2312_1980_0[]	  = { "EUC-CN", "GB2312", "gb2312", /* solaris */
	    "dechanzi",					    /* osf */
	    "hp15CN",					    /* hpux */
	    "IBM-eucCN",				    /* aix */
	    "eucCN",					    /* irix */
...
char *iso8859_1[]  = { "ISO-8859-1",	       /* gnu */
	 ...
	 "8859-1",			       /* solaris ? */
	 "iso81",			       /* hpux */
	 "ascii", "ASCII", "646",	       /* solaris */
	 "ANSI_X3.4-1968", "ISO_646.IRV:1983", /* old glibc */
	 "american_e", NULL };
char *iso8859_2[]  = { "ISO-8859-2", "ISO8859-2", "iso8859-2", "iso88592",
	 "8859-2", "iso82", NULL };
char *iso8859_3[]  = { "ISO-8859-3", "ISO8859-3", "iso8859-3", "iso88593",
	 "8859-3", "iso83", NULL };
char *iso8859_4[]  = { "ISO-8859-4", "ISO8859-4", "iso8859-4", "iso88594",
	 "8859-4", "iso84", NULL };
char *iso8859_5[]  = { "ISO-8859-5", "ISO8859-5", "iso8859-5", "iso88595",
	 "8859-5", "iso85", NULL };
char *iso8859_6[]  = { "ISO-8859-6", "ISO8859-6", "iso8859-6", "iso88596",
	 "8859-6", "iso86", NULL };
char *iso8859_7[]  = { "ISO-8859-7", "ISO8859-7", "iso8859-7", "iso88597",
	 "8859-7", "iso87", NULL };
char *iso8859_8[]  = { "ISO-8859-8", "ISO8859-8", "iso88859-8", "iso88598",
	 "8859-8", "iso88", NULL };
char *iso8859_9[]  = { "ISO-8859-9", "ISO8859-9", "iso8859-9", "iso88599",
	 "8859-9", "iso89", NULL };
char *iso8859_10[] = { "ISO-8859-10", "ISO8859-10", "iso8859-10", "iso885910",
	"8859-10", "iso80", /*?*/
	"iso10", NULL };
char *iso8859_13[] = { "ISO-8859-13", "ISO8859-13", "iso8859-13", "iso885913",
	"8859-13", "IBM-921", /* aix */
	"iso813",	      /*?*/
	"iso13", NULL };
char *iso8859_14[] = { "ISO-8859-14", "ISO8859-14", "iso8859-14", "iso885914",
	"8859-14", "iso814", "iso14", NULL };
char *iso8859_15[] = { "ISO-8859-15", "ISO88859-15", "iso88859-15", "iso885915",
	"8859-15", "iso815", "iso15", NULL };
char *iso8859_16[] = { "ISO-8859-16", "ISO8859-16", "iso8859-16", "iso885916",
	"8859-16", "iso80", "iso16", NULL };
char *jisx0201_1976_0[]	 = { "JIS_X0201", "ISO-IR-14", "jis", /* hpux */
	 NULL };
...
char *koi8_r[]		 = { "KOI8-R", /* gnu, solaris */
		  NULL };
char *koi8_u[]		 = { "KOI8-U", NULL };
char *ksc5601[]		 = { "KSC5636", "ko_KR-johap", /* solaris */
		 "ko_KR-johap92", "ko_KR-euc", "eucKR", "EUC-KR", "EUCKR", "euc-kr",
		 "CP949", /* osf */
		 NULL };
char *microsoft_cp1251[] = { "CP1251", NULL };
char *microsoft_cp1255[] = { "CP1255", NULL };
char *microsoft_cp1256[] = { "CP1256", NULL };
char *mulelao_1[]	 = { "MULELAO-1", "MULELAO", NULL };
char *sjisx_1[]		 = { "SHIFT_JIS", "SJIS", /* solaris, osf */
		 "sjis",			  /* hpux */
		 "PCK",				  /* solaris */
		 NULL };
char *tatar_cyr[]	 = { NULL };
char *tcvn_5712[]	 = { "TCVN", NULL };
char *tis620_0[]	 = { "TIS-620", "tis620", /* hpux */
		"TACTIS",			  /* osf */
		NULL };
char *viscii1_1_1[]	 = { "VISCII", NULL };
/* encofing only ...*/
char *utf_8[]  = { "UTF-8", /* gnu, solaris */
	 "UTF8", "utf8", "utf_8", NULL };
char *usc_2[]  = { "USC-2", "USC2", "usc2", "usc-2", "usc_2", NULL };
char *usc_4[]  = { "USC-4", "USC4", "usc4", "usc-4", "usc_4", NULL };
char *utf_16[] = { "UTF-16", "UTF16", "utf16", "utf_16", NULL };
char *euc_jp[] = { "EUC-JP", "EUCJP", "euc_jp", "euc-jp", "eucjp", NULL };
#endif
...
#define CT_ENTRY(x, y, z)                                         \
	{                                                         \
		x, y, FLC_INDEX_ICONV_CHARSET_NOT_INITIALIZED, z, \
...
#define CT_ENTRY(x, y, z)                                            \
	{                                                            \
		x, y, FLC_INDEX_ICONV_CHARSET_NOT_INITIALIZED, NULL, \
		    FLC_ENCODING_TYPE_FONT                           \
	}
#define CT_ENTRY_WET(x, y, z, t)                                       \
	{                                                              \
...
#define CT_ENTRY(x, y, z)                                        \
	{                                                        \
		x, nullsl, FLC_INDEX_ICONV_CHARSET_NOT_FOUND, z, \
		    FLC_ENCODING_TYPE_FONT                       \
	}
#define CT_ENTRY_WET(x, y, z, t)                                   \
	{                                                          \
...
#define CT_ENTRY(x, y, z)                                           \
	{                                                           \
		x, nullsl, FLC_INDEX_ICONV_CHARSET_NOT_FOUND, NULL, \
		    FLC_ENCODING_TYPE_FONT                          \
	}
#define CT_ENTRY_WET(x, y, z, t)                                      \
	{                                                             \
...
static FlocaleCharset UnknownCharset = { "Unknown", nullsl,
	FLC_INDEX_ICONV_CHARSET_NOT_FOUND, NULL };
...
FlocaleCharset FlocaleCharsetTable[] = {
	...
	CT_ENTRY("KOI8-C", koi8_r, NULL), CT_ENTRY("KOI8-R", koi8_r, NULL),
	...
	CT_ENTRY("TIS620.2533-1", tis620_0, NULL), CT_ENTRY(NULL, nullsl, NULL)
};
...
static FlocaleCharset *
FlocaleCharsetOfFontStruct(Display *dpy, XFontStruct *fs)
{
...
static void
FlocaleInit_X_Charset(Display *dpy, const char *module)
{
	...
	if (FLCXOMCharsetList_num > 0 && FLCXOMCharsetList[0]) {
		...
		fvwm_debug(__func__,
		    "[FlocaleInitCharset] XOM charset "
		    "%i: %s\n",
		    i, FLC_DEBUG_GET_X_CHARSET(FLCXOMCharset));
#endif
	}
#endif
}
...
void
FlocaleCharsetInit(Display *dpy, const char *module)
{
...
#if FLOCALE_DEBUG_CHARSET
	fvwm_debug(__func__, "[FlocaleInitCharset] CHARSET: %s\n",
...
#if FLOCALE_DEBUG_CHARSET
		fvwm_debug(__func__, "[FlocaleInitCharset] Fnl_langinfo: %s\n",
		    (!charset) ? "null" : charset);
#endif
	}
	if (charset != NULL && strlen(charset) > 2) {
		FLCLocaleCharset = FlocaleCharsetOfLocaleCharset(charset);
#if FLOCALE_DEBUG_CHARSET
		fvwm_debug(__func__,
		    "[FlocaleInitCharset] FLCLocaleCharset: %s\n", charset);
#endif
...
void
FlocaleCharsetSetFlocaleCharset(Display *dpy, FlocaleFont *flf, char *hints,
    char *encoding, char *module)
{
	char *charset	  = NULL;
	char *iconv	  = NULL;
	...
	if (flf->fc == NULL) {
		if (FftSupport && flf->fftf.fftfont[0] != NULL) {
			...
			if (FLCXOMCharset != NULL) {
				...
				if (XFontsOfFontSet(flf->fontset, &fs_list,
					&ml) > 0) {
					flf->fc = FLCXOMCharset =
	...
	if (flf->fc != NULL && iconv && *iconv) {
		...
		while (!iconv_found &&
			...
			if (strcmp(iconv, FLC_GET_LOCALE_CHARSET(flf->fc, i)) ==
			    0) {
				iconv_found = True;
				/* Trust the user? yes ... */
	...
	if (iconv && *iconv && !iconv_found) {
		...
		fc			= fxmalloc(sizeof(FlocaleCharset));
		if (flf->fc != NULL) {
		...
		fc->locale = fxmalloc(2 * sizeof(char *));
...
FlocaleCharset *
FlocaleCharsetGetDefaultCharset(Display *dpy, char *module)
{
	...
	if (warn) {
		...
		fvwm_debug(__func__, "\n");
		/* never null */
		FLCLocaleCharset = FlocaleCharsetOfXCharset(
...
const char *
FlocaleGetBidiCharset(Display *dpy, FlocaleCharset *fc)
{
...
Bool
FlocaleCharsetIsCharsetXLocale(Display *dpy, char *charset, char *module)
{
#ifdef HAVE_XOUTPUT_METHOD
	int i;
	...
	if (FLCXOMCharsetList_num > 0) {
		for (i = 0; i < FLCXOMCharsetList_num; i++) {
			if (StrEquals(FLC_DEBUG_GET_X_CHARSET(
					  FLCXOMCharsetList[i]),
				charset)) {
				return True;
			}
...
void
FlocaleCharsetPrintXOMInfo(void)
{
#ifdef HAVE_XOUTPUT_METHOD
	int i;
