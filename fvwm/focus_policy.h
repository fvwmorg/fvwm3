...
#define FP_DO_RAISE_FOCUSED_CLICK(fp) ((fp).do_raise_focused_click)
#define FP_DO_RAISE_UNFOCUSED_CLICK(fp) ((fp).do_raise_unfocused_click)
#define FP_DO_FOCUS_CLICK(fp) ((fp).do_focus_click)
...
#define FP_DO_RAISE_FOCUSED_DECOR_CLICK(fp) ((fp).do_raise_focused_click.decor)
...
#define FP_DO_RAISE_FOCUSED_ICON_CLICK(fp) ((fp).do_raise_focused_click.icon)
...
#define FP_DO_FOCUS_ENTER(fp) ((fp).do_focus_enter)
#define FPS_FOCUS_ENTER(fp, x) ((fp).do_focus_enter = !!(x))
#define FP_DO_UNFOCUS_LEAVE(fp) ((fp).do_unfocus_leave)
#define FPS_UNFOCUS_LEAVE(fp, x) ((fp).do_unfocus_leave = !!(x))
#define FP_DO_FOCUS_CLICK_CLIENT(fp) ((fp).do_focus_click.client)
#define FPS_FOCUS_CLICK_CLIENT(fp, x) ((fp).do_focus_click.client = !!(x))
#define FP_DO_FOCUS_CLICK_DECOR(fp) ((fp).do_focus_click.decor)
#define FPS_FOCUS_CLICK_DECOR(fp, x) ((fp).do_focus_click.decor = !!(x))
#define FP_DO_FOCUS_CLICK_ICON(fp) ((fp).do_focus_click.icon)
#define FPS_FOCUS_CLICK_ICON(fp, x) ((fp).do_focus_click.icon = !!(x))
#define FP_DO_FOCUS_BY_PROGRAM(fp) ((fp).do_focus_by_program)
#define FPS_FOCUS_BY_PROGRAM(fp, x) ((fp).do_focus_by_program = !!(x))
#define FP_DO_FOCUS_BY_FUNCTION(fp) ((fp).do_focus_by_function)
#define FPS_FOCUS_BY_FUNCTION(fp, x) ((fp).do_focus_by_function = !!(x))
...
#define FP_IS_LENIENT(fp) ((fp).is_lenient)
#define FPS_LENIENT(fp, x) ((fp).is_lenient = !!(x))
#define FP_USE_MOUSE_BUTTONS(fp) ((fp).use_mouse_buttons)
#define FPS_MOUSE_BUTTONS(fp, x) ((fp).use_mouse_buttons = (x))
#define FP_USE_MODIFIERS(fp) ((fp).use_modifiers)
#define FPS_MODIFIERS(fp, x) ((fp).use_modifiers = (x))
#define FP_DO_PASS_FOCUS_CLICK(fp) ((fp).do_pass_focus_click)
#define FPS_PASS_FOCUS_CLICK(fp, x) ((fp).do_pass_focus_click = !!(x))
#define FP_DO_PASS_RAISE_CLICK(fp) ((fp).do_pass_raise_click)
#define FPS_PASS_RAISE_CLICK(fp, x) ((fp).do_pass_raise_click = !!(x))
#define FP_DO_IGNORE_FOCUS_CLICK_MOTION(fp) ((fp).do_ignore_focus_click_motion)
#define FPS_IGNORE_FOCUS_CLICK_MOTION(fp, x) \
	((fp).do_ignore_focus_click_motion = !!(x))
#define FP_DO_IGNORE_RAISE_CLICK_MOTION(fp) ((fp).do_ignore_raise_click_motion)
#define FPS_IGNORE_RAISE_CLICK_MOTION(fp, x) \
	((fp).do_ignore_raise_click_motion = !!(x))
#define FP_DO_ALLOW_FUNC_FOCUS_CLICK(fp) ((fp).do_allow_func_focus_click)
#define FPS_ALLOW_FUNC_FOCUS_CLICK(fp, x) \
	((fp).do_allow_func_focus_click = !!(x))
#define FP_DO_ALLOW_FUNC_RAISE_CLICK(fp) ((fp).do_allow_func_raise_click)
#define FPS_ALLOW_FUNC_RAISE_CLICK(fp, x) \
	((fp).do_allow_func_raise_click = !!(x))
#define FP_DO_GRAB_FOCUS(fp) ((fp).do_open_grabs_focus)
#define FPS_GRAB_FOCUS(fp, x) ((fp).do_open_grabs_focus = !!(x))
#define FP_DO_GRAB_FOCUS_TRANSIENT(fp) ((fp).do_open_grabs_focus_transient)
#define FPS_GRAB_FOCUS_TRANSIENT(fp, x) \
	((fp).do_open_grabs_focus_transient = !!(x))
#define FP_DO_OVERRIDE_GRAB_FOCUS(fp) ((fp).do_override_grab_focus)
#define FPS_OVERRIDE_GRAB_FOCUS(fp, x) ((fp).do_override_grab_focus = !!(x))
#define FP_DO_RELEASE_FOCUS(fp) ((fp).do_close_releases_focus)
#define FPS_RELEASE_FOCUS(fp, x) ((fp).do_close_releases_focus = !!(x))
...
#define FP_DO_OVERRIDE_RELEASE_FOCUS(fp) ((fp).do_override_release_focus)
#define FPS_OVERRIDE_RELEASE_FOCUS(fp, x) \
	((fp).do_override_release_focus = !!(x))
#define FP_DO_SORT_WINDOWLIST_BY(fp) ((fp).do_sort_windowlist_by)
#define FPS_SORT_WINDOWLIST_BY(fp, x) ((fp).do_sort_windowlist_by = !!(x))
