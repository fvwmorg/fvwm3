...
void
EWMH_SetCurrentDesktop(struct monitor *);
void
EWMH_SetNumberOfDesktops(struct monitor *);
void
EWMH_SetDesktopViewPort(struct monitor *);
void
EWMH_SetDesktopGeometry(struct monitor *);
...
void
EWMH_SetClientList(struct monitor *);
void
EWMH_SetClientListStacking(struct monitor *);
void
EWMH_UpdateWorkArea(struct monitor *);
void
...
void
EWMH_Init(struct monitor *);
void
EWMH_ExitStuff(void);

/* ewmh_conf.c */
void
set_ewmhc_strut_values(struct monitor *, int *);
...
int
EWMH_WMName(FvwmWindow *fw, XEvent *ev, window_style *style, unsigned long any);
int
EWMH_WMIconName(
    FvwmWindow *fw, XEvent *ev, window_style *style, unsigned long any);
void
EWMH_SetDesktopNames(struct monitor *);
void
