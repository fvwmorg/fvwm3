...
typedef struct {
	 ...
	 * possible */
	const char *(*parse_command_name)(cmdparser_context_t *context,
	    void *func_rc, const void *exc);
	...
	void (*expand_command_line)(cmdparser_context_t *context, int is_addto,
	    void *func_rc, const void *exc);
	...
	cmdparser_execute_type_t (
	    *find_something_to_execute)(cmdparser_context_t *context,
