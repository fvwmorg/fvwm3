...
#define SDO_PASS_CLICK_FOCUS_CLICK(sf) ((sf).common.s.do_pass_click_focus_click)
#define SFDO_PASS_CLICK_FOCUS_CLICK(st) ((st).flags.common.s.do_pass_click_focus_click)
#define SMDO_PASS_CLICK_FOCUS_CLICK(st) ((st).flag_mask.common.s.do_pass_click_focus_click)
#define SCDO_PASS_CLICK_FOCUS_CLICK(st) ((st).change_mask.common.s.do_pass_click_focus_click)
#define SFSET_DO_PASS_CLICK_FOCUS_CLICK(st,x) ((st).flags.common.s.do_pass_click_focus_click = !!(x))
#define SMSET_DO_PASS_CLICK_FOCUS_CLICK(st,x) ((st).flag_mask.common.s.do_pass_click_focus_click = !!(x))
#define SCSET_DO_PASS_CLICK_FOCUS_CLICK(st,x) ((st).change_mask.common.s.do_pass_click_focus_click = !!(x))
#define SDO_RAISE_CLICK_FOCUS_CLICK(sf)  ((sf).common.s.do_raise_click_focus_click)
#define SFDO_RAISE_CLICK_FOCUS_CLICK(st) ((st).flags.common.s.do_raise_click_focus_click)
#define SMDO_RAISE_CLICK_FOCUS_CLICK(st) ((st).flag_mask.common.s.do_raise_click_focus_click)
#define SCDO_RAISE_CLICK_FOCUS_CLICK(st) ((st).change_mask.common.s.do_raise_click_focus_click)
#define SFSET_DO_RAISE_CLICK_FOCUS_CLICK(st,x) ((st).flags.common.s.do_raise_click_focus_click = !!(x))
#define SMSET_DO_RAISE_CLICK_FOCUS_CLICK(st,x) ((st).flag_mask.common.s.do_raise_click_focus_click = !!(x))
#define SCSET_DO_RAISE_CLICK_FOCUS_CLICK(st,x) ((st).change_mask.common.s.do_raise_click_focus_click = !!(x))
...
#define SDO_SCROLL_WINDOWSHADE(sf ) ((sf).common.s.do_scroll_windowshade)
#define SFDO_SCROLL_WINDOWSHADE(st) ((st).flags.common.s.do_scroll_windowshade)
#define SMDO_SCROLL_WINDOWSHADE(st) ((st).flag_mask.common.s.do_scroll_windowshade)
#define SCDO_SCROLL_WINDOWSHADE(st) ((st).change_mask.common.s.do_scroll_windowshade)
#define SFSET_DO_SCROLL_WINDOWSHADE(st,x) ((st).flags.common.s.do_scroll_windowshade = !!(x))
#define SMSET_DO_SCROLL_WINDOWSHADE(st,x) ((st).flag_mask.common.s.do_scroll_windowshade = !!(x))
#define SCSET_DO_SCROLL_WINDOWSHADE(st,x) ((st).change_mask.common.s.do_scroll_windowshade = !!(x))
