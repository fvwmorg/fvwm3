...
#define SHAS_STIPLED_TITLE(sf) ((sf).common.s.has_stipled_title)
#define SFHAS_STIPLED_TITLE(st) ((st).flags.common.s.has_stipled_title)
#define SMHAS_STIPLED_TITLE(st) ((st).flag_mask.common.s.has_stipled_title)
#define SCHAS_STIPLED_TITLE(st) ((st).change_mask.common.s.has_stipled_title)
#define SFSET_HAS_STIPLED_TITLE(st,x) ((st).flags.common.s.has_stipled_title = !!(x))
#define SMSET_HAS_STIPLED_TITLE(st,x) ((st).flag_mask.common.s.has_stipled_title = !!(x))
#define SCSET_HAS_STIPLED_TITLE(st,x) ((st).change_mask.common.s.has_stipled_title = !!(x))
