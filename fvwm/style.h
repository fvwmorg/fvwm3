...
#define SHAS_ICON_FONT(sf) ((sf).common.s.has_icon_font)
#define SFHAS_ICON_FONT(st) ((st).flags.common.s.has_icon_font)
#define SMHAS_ICON_FONT(st) ((st).flag_mask.common.s.has_icon_font)
#define SCHAS_ICON_FONT(st) ((st).change_mask.common.s.has_icon_font)
#define SFSET_HAS_ICON_FONT(st,x) ((st).flags.common.s.has_icon_font = !!(x))
#define SMSET_HAS_ICON_FONT(st,x) ((st).flag_mask.common.s.has_icon_font = !!(x))
#define SCSET_HAS_ICON_FONT(st,x) ((st).change_mask.common.s.has_icon_font = !!(x))
...
#define SHAS_WINDOW_FONT(sf) ((sf).common.s.has_window_font)
#define SFHAS_WINDOW_FONT(st) ((st).flags.common.s.has_window_font)
#define SMHAS_WINDOW_FONT(st) ((st).flag_mask.common.s.has_window_font)
#define SCHAS_WINDOW_FONT(st) ((st).change_mask.common.s.has_window_font)
#define SFSET_HAS_WINDOW_FONT(st,x) ((st).flags.common.s.has_window_font = !!(x))
#define SMSET_HAS_WINDOW_FONT(st,x) ((st).flag_mask.common.s.has_window_font = !!(x))
#define SCSET_HAS_WINDOW_FONT(st,x) ((st).change_mask.common.s.has_window_font = !!(x))
