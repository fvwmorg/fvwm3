...
#define SHAS_NO_BORDER(sf) ((sf).common.s.has_no_border)
#define SFHAS_NO_BORDER(st) ((st).flags.common.s.has_no_border)
#define SMHAS_NO_BORDER(st) ((st).flag_mask.common.s.has_no_border)
#define SCHAS_NO_BORDER(st) ((st).change_mask.common.s.has_no_border)
#define SFSET_HAS_NO_BORDER(st,x) ((st).flags.common.s.has_no_border = !!(x))
#define SMSET_HAS_NO_BORDER(st,x) ((st).flag_mask.common.s.has_no_border = !!(x))
#define SCSET_HAS_NO_BORDER(st,x) ((st).change_mask.common.s.has_no_border = !!(x))
...
#define SIS_BOTTOM_TITLE_ROTATED(sf) ((sf).common.s.is_bottom_title_rotated)
#define SFIS_BOTTOM_TITLE_ROTATED(st) ((st).flags.common.s.is_bottom_title_rotated)
#define SMIS_BOTTOM_TITLE_ROTATED(st) ((st).flag_mask.common.s.is_bottom_title_rotated)
#define SCIS_BOTTOM_TITLE_ROTATED(st) ((st).change_mask.common.s.is_bottom_title_rotated)
#define SFSET_IS_BOTTOM_TITLE_ROTATED(st,x) ((st).flags.common.s.is_bottom_title_rotated = !!(x))
#define SMSET_IS_BOTTOM_TITLE_ROTATED(st,x) ((st).flag_mask.common.s.is_bottom_title_rotated = !!(x))
#define SCSET_IS_BOTTOM_TITLE_ROTATED(st,x) ((st).change_mask.common.s.is_bottom_title_rotated = !!(x))
...
#define SIS_LEFT_TITLE_ROTATED_CW(sf) ((sf).common.s.is_left_title_rotated_cw)
#define SFIS_LEFT_TITLE_ROTATED_CW(st) ((st).flags.common.s.is_left_title_rotated_cw)
#define SMIS_LEFT_TITLE_ROTATED_CW(st) ((st).flag_mask.common.s.is_left_title_rotated_cw)
#define SCIS_LEFT_TITLE_ROTATED_CW(st) ((st).change_mask.common.s.is_left_title_rotated_cw)
#define SFSET_IS_LEFT_TITLE_ROTATED_CW(st,x) ((st).flags.common.s.is_left_title_rotated_cw = !!(x))
#define SMSET_IS_LEFT_TITLE_ROTATED_CW(st,x) ((st).flag_mask.common.s.is_left_title_rotated_cw = !!(x))
#define SCSET_IS_LEFT_TITLE_ROTATED_CW(st,x) ((st).change_mask.common.s.is_left_title_rotated_cw = !!(x))
...
#define SIS_RIGHT_TITLE_ROTATED_CW(sf) ((sf).common.s.is_right_title_rotated_cw)
#define SFIS_RIGHT_TITLE_ROTATED_CW(st) ((st).flags.common.s.is_right_title_rotated_cw)
#define SMIS_RIGHT_TITLE_ROTATED_CW(st) ((st).flag_mask.common.s.is_right_title_rotated_cw)
#define SCIS_RIGHT_TITLE_ROTATED_CW(st) ((st).change_mask.common.s.is_right_title_rotated_cw)
#define SFSET_IS_RIGHT_TITLE_ROTATED_CW(st,x) ((st).flags.common.s.is_right_title_rotated_cw = !!(x))
#define SMSET_IS_RIGHT_TITLE_ROTATED_CW(st,x) ((st).flag_mask.common.s.is_right_title_rotated_cw = !!(x))
#define SCSET_IS_RIGHT_TITLE_ROTATED_CW(st,x) ((st).change_mask.common.s.is_right_title_rotated_cw = !!(x))
#define SIS_TOP_TITLE_ROTATED(sf) ((sf).common.s.is_top_title_rotated)
#define SFIS_TOP_TITLE_ROTATED(st) ((st).flags.common.s.is_top_title_rotated)
#define SMIS_TOP_TITLE_ROTATED(st) ((st).flag_mask.common.s.is_top_title_rotated)
#define SCIS_TOP_TITLE_ROTATED(st) ((st).change_mask.common.s.is_top_title_rotated)
#define SFSET_IS_TOP_TITLE_ROTATED(st,x) ((st).flags.common.s.is_top_title_rotated = !!(x))
#define SMSET_IS_TOP_TITLE_ROTATED(st,x) ((st).flag_mask.common.s.is_top_title_rotated = !!(x))
#define SCSET_IS_TOP_TITLE_ROTATED(st,x) ((st).change_mask.common.s.is_top_title_rotated = !!(x))
...
#define SWINDOWSHADE_LAZINESS(sf) ((sf).common.s.windowshade_laziness)
#define SFWINDOWSHADE_LAZINESS(st) ((st).flags.common.s.windowshade_laziness)
#define SMWINDOWSHADE_LAZINESS(st) ((st).flag_mask.common.s.windowshade_laziness)
#define SCWINDOWSHADE_LAZINESS(st) ((st).change_mask.common.s.windowshade_laziness)
#define SFSET_WINDOWSHADE_LAZINESS(st,x) ((st).flags.common.s.windowshade_laziness = (x))
#define SMSET_WINDOWSHADE_LAZINESS(st,x) ((st).flag_mask.common.s.windowshade_laziness = (x))
#define SCSET_WINDOWSHADE_LAZINESS(st,x) ((st).change_mask.common.s.windowshade_laziness = (x))
