...
#define FW_FOCUS_POLICY(fw) ((fw)->flags.common.s.focus_policy)

#define DO_LOWER_TRANSIENT(fw) ((fw)->flags.common.s.do_lower_transient)
#define DO_NOT_SHOW_ON_MAP(fw) ((fw)->flags.common.s.do_not_show_on_map)
...
#define DO_SHRINK_WINDOWSHADE(fw) ((fw)->flags.common.s.do_shrink_windowshade)
...
#define DO_SKIP_CIRCULATE(fw) ((fw)->flags.common.s.do_circulate_skip)
...
#define DO_SKIP_ICON_CIRCULATE(fw) ((fw)->flags.common.s.do_circulate_skip_icon)
...
#define DO_SKIP_WINDOW_LIST(fw) ((fw)->flags.common.s.do_window_list_skip)
...
#define SET_USER_STATES(fw, mask) ((fw)->flags.common.user_states |= (mask))
#define CLEAR_USER_STATES(fw, mask) ((fw)->flags.common.user_states &= ~(mask))
#define TOGGLE_USER_STATES(fw, mask) ((fw)->flags.common.user_states ^= (mask))
#define SETM_USER_STATES(fw, mask) \
	((fw)->flag_mask.common.user_states |= (mask))
#define GET_USER_STATES(fw) ((fw)->flags.common.user_states)
#define GETM_USER_STATES(fw) ((fw)->flag_mask.common.user_states)
#define HAS_VERTICAL_TITLE(fw) \
	((HAS_TITLE_DIR(fw, DIR_W) || HAS_TITLE_DIR(fw, DIR_E)))
#define HAS_STIPPLED_TITLE(fw) ((fw)->flags.common.s.has_stippled_title)
...
#define ICON_OVERRIDE_MODE(fw) ((fw)->flags.common.s.icon_override)
...
#define USE_ICON_POSITION_HINT(fw) ((fw)->flags.common.s.use_icon_position_hint)
...
#define USE_INDEXED_ICON_NAME(fw) ((fw)->flags.common.s.use_indexed_icon_name)
...
#define WINDOWSHADE_LAZINESS(fw) ((fw)->flags.common.s.windowshade_laziness)
#define SET_WINDOWSHADE_LAZINESS(fw, x) \
	(fw)->flags.common.s.windowshade_laziness = ((x)&WINDOWSHADE_LAZY_MASK)
...
#define DO_EWMH_DONATE_ICON(fw) ((fw)->flags.common.s.do_ewmh_donate_icon)
...
#define EWMH_MAXIMIZE_MODE(fw) ((fw)->flags.common.s.ewmh_maximize_mode)
...
#define IS_ICON_SUPPRESSED(fw) ((fw)->flags.common.s.is_icon_suppressed)
...
#define IS_STICKY_ACROSS_PAGES(fw) ((fw)->flags.common.is_sticky_across_pages)
...
#define IS_STICKY_ACROSS_DESKS(fw) ((fw)->flags.common.is_sticky_across_desks)
...
#define HAS_ICON_FONT(fw) ((fw)->flags.common.has_icon_font)
#define SET_HAS_ICON_FONT(fw, x) (fw)->flags.common.has_icon_font = !!(x)
#define SETM_HAS_ICON_FONT(fw, x) (fw)->flag_mask.common.has_icon_font = !!(x)
#define HAS_NO_ICON_TITLE(fw) ((fw)->flags.common.s.has_no_icon_title)
...
#define HAS_WINDOW_FONT(fw) ((fw)->flags.common.has_window_font)
#define SET_HAS_WINDOW_FONT(fw, x) (fw)->flags.common.has_window_font = !!(x)
...
#define HAS_MWM_OVERRIDE_HINTS(fw) ((fw)->flags.common.s.has_mwm_override)
#define HAS_OVERRIDE_SIZE_HINTS(fw) ((fw)->flags.common.s.has_override_size)
#define DO_ICONIFY_WINDOW_GROUPS(fw) \
	((fw)->flags.common.s.do_iconify_window_groups)
#define DO_IGNORE_GNOME_HINTS(fw) ((fw)->flags.common.s.do_ignore_gnome_hints)
#define DO_IGNORE_RESTACK(fw) ((fw)->flags.common.s.do_ignore_restack)
#define DO_IGNORE_ICON_BOXES(fw) ((fw)->flags.common.s.do_ignore_icon_boxes)
...
#define SET_PSIZE_FIXED(fw, x) (fw)->flags.common.s.is_psize_fixed = !!(x)
#define SETM_PSIZE_FIXED(fw, x) (fw)->flag_mask.common.s.is_psize_fixed = !!(x)
#define IS_UNICONIFIABLE(fw) ((fw)->flags.common.s.is_uniconifiable)
...
#define IS_UNMAXIMIZABLE(fw) ((fw)->flags.common.s.is_unmaximizable)
...
#define IS_UNCLOSABLE(fw) ((fw)->flags.common.s.is_unclosable)
#define SET_IS_UNCLOSABLE(fw, x) (fw)->flags.common.s.is_unclosable = !!(x)
#define SETM_IS_UNCLOSABLE(fw, x) (fw)->flag_mask.common.s.is_unclosable = !!(x)
...
#define SET_DO_REUSE_DESTROYED(fw, x) (fw)->flags.do_reuse_destroyed = !!(x)
#define SETM_DO_REUSE_DESTROYED(fw, x) \
	(fw)->flag_mask.do_reuse_destroyed = !!(x)
#define HAS_NO_BORDER(fw) ((fw)->flags.common.has_no_border)
#define SET_HAS_NO_BORDER(fw, x) (fw)->flags.common.has_no_border = !!(x)
#define SETM_HAS_NO_BORDER(fw, x) (fw)->flag_mask.common.has_no_border = !!(x)
...
#define HAS_NEW_WM_NORMAL_HINTS(fw) ((fw)->flags.has_new_wm_normal_hints)
...
#define IS_ICONIFIED_BY_PARENT(fw) ((fw)->flags.is_iconified_by_parent)
...
#define SET_ICON_UNMAPPED(fw, x) (fw)->flags.is_icon_unmapped = !!(x)
#define SETM_ICON_UNMAPPED(fw, x) (fw)->flag_mask.is_icon_unmapped = !!(x)
...
#define IS_TEAR_OFF_MENU(fw) ((fw)->flags.is_tear_off_menu)
#define SET_TEAR_OFF_MENU(fw, x) (fw)->flags.is_tear_off_menu = !!(x)
#define SETM_TEAR_OFF_MENU(fw, x) (fw)->flag_mask.is_tear_off_menu = !!(x)
...
#define SETM_ICONIFY_PENDING(fw, x) (fw)->flag_mask.is_iconify_pending = !!(x)
...
#define SET_VIEWPORT_MOVED(fw, x) (fw)->flags.is_viewport_moved = !!(x)
#define SETM_VIEWPORT_MOVED(fw, x) (fw)->flag_mask.is_viewport_moved = !!(x)
#define IS_VIEWPORT_MOVED(fw) ((fw)->flags.is_viewport_moved)
...
#define SET_FULLY_VISIBLE(fw, x) (fw)->flags.is_fully_visible = !!(x)
#define SETM_FULLY_VISIBLE(fw, x) (fw)->flag_mask.is_fully_visible = !!(x)
#define IS_PARTIALLY_VISIBLE(fw) ((fw)->flags.is_partially_visible)
#define SET_PARTIALLY_VISIBLE(fw, x) (fw)->flags.is_partially_visible = !!(x)
#define SETM_PARTIALLY_VISIBLE(fw, x) \
	(fw)->flag_mask.is_partially_visible = !!(x)
#define IS_WINDOW_DRAWN_ONCE(fw) ((fw)->flags.is_window_drawn_once)
#define SET_WINDOW_DRAWN_ONCE(fw, x) (fw)->flags.is_window_drawn_once = !!(x)
...
#define CR_MOTION_METHOD(fw) ((fw)->flags.cr_motion_method)
...
#define SET_WM_DELETES_WINDOW(fw, x) (fw)->flags.does_wm_delete_window = !!(x)
...
#define SET_WM_TAKES_FOCUS(fw, x) (fw)->flags.does_wm_take_focus = !!(x)
#define SETM_WM_TAKES_FOCUS(fw, x) (fw)->flag_mask.does_wm_take_focus = !!(x)
...
#define USING_DEFAULT_WINDOW_FONT(fw) ((fw)->flags.using_default_window_font)
...
#define USING_DEFAULT_ICON_FONT(fw) ((fw)->flags.using_default_icon_font)
...
#define WAS_ICON_HINT_PROVIDED(fw) ((fw)->flags.was_icon_hint_provided)
...
#define WAS_ICON_NAME_PROVIDED(fw) ((fw)->flags.was_icon_name_provided)
...
#define WAS_NEVER_DRAWN(fw) ((fw)->flags.was_never_drawn)
#define SET_WAS_NEVER_DRAWN(fw, x) (fw)->flags.was_never_drawn = (x)
#define SETM_WAS_NEVER_DRAWN(fw, x) (fw)->flag_mask.was_never_drawn = (x)
...
#define HAS_EWMH_WM_ICON_NAME(fw) ((fw)->flags.has_ewmh_wm_icon_name)
...
#define HAS_EWMH_WM_PID(fw) ((fw)->flags.has_ewmh_wm_pid)
#define SET_HAS_EWMH_WM_PID(fw, x) (fw)->flags.has_ewmh_wm_pid = !!(x)
#define SETM_HAS_EWMH_WM_PID(fw, x) (fw)->flag_mask.has_ewmh_wm_pid = !!(x)
#define IS_EWMH_MODAL(fw) ((fw)->flags.is_ewmh_modal)
#define SET_EWMH_MODAL(fw, x) (fw)->flags.is_ewmh_modal = !!(x)
#define SETM_EWMH_MODAL(fw, x) (fw)->flag_mask.is_ewmh_modal = !!(x)
#define IS_EWMH_FULLSCREEN(fw) ((fw)->flags.is_ewmh_fullscreen)
#define SET_EWMH_FULLSCREEN(fw, x) (fw)->flags.is_ewmh_fullscreen = !!(x)
#define SETM_EWMH_FULLSCREEN(fw, x) (fw)->flag_mask.is_ewmh_fullscreen = !!(x)
...
#define HAS_EWMH_INIT_HIDDEN_STATE(fw) ((fw)->flags.has_ewmh_init_hidden_state)
...
#define HAS_EWMH_INIT_MODAL_STATE(fw) ((fw)->flags.has_ewmh_init_modal_state)
...
#define HAS_EWMH_INIT_SHADED_STATE(fw) ((fw)->flags.has_ewmh_init_shaded_state)
...
#define HAS_EWMH_INIT_STICKY_STATE(fw) ((fw)->flags.has_ewmh_init_sticky_state)
...
#define HAS_EWMH_INIT_WM_DESKTOP(fw) ((fw)->flags.has_ewmh_init_wm_desktop)
