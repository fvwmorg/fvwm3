...
int ewmh_HandleDesktop(EWMH_CMD_ARGS)
{
  ...
  FPS_PASS_FOCUS_CLICK(SF_FOCUS_POLICY(*style), 0);
  FPS_PASS_FOCUS_CLICK(SM_FOCUS_POLICY(*style), 1);
  FPS_PASS_FOCUS_CLICK(SC_FOCUS_POLICY(*style), 1);
  FPS_PASS_RAISE_CLICK(SF_FOCUS_POLICY(*style), 0);
  FPS_PASS_RAISE_CLICK(SM_FOCUS_POLICY(*style), 1);
  FPS_PASS_RAISE_CLICK(SC_FOCUS_POLICY(*style), 1);

  /* not useful */
  FPS_RAISE_FOCUSED_CLIENT_CLICK(SF_FOCUS_POLICY(*style), 0);
  FPS_RAISE_FOCUSED_CLIENT_CLICK(SM_FOCUS_POLICY(*style), 1);
  FPS_RAISE_FOCUSED_CLIENT_CLICK(SC_FOCUS_POLICY(*style), 1);
  FPS_RAISE_UNFOCUSED_CLIENT_CLICK(SF_FOCUS_POLICY(*style), 0);
  FPS_RAISE_UNFOCUSED_CLIENT_CLICK(SM_FOCUS_POLICY(*style), 1);
  FPS_RAISE_UNFOCUSED_CLIENT_CLICK(SC_FOCUS_POLICY(*style), 1);
  FPS_RAISE_FOCUSED_DECOR_CLICK(SF_FOCUS_POLICY(*style), 0);
  FPS_RAISE_FOCUSED_DECOR_CLICK(SM_FOCUS_POLICY(*style), 1);
  FPS_RAISE_FOCUSED_DECOR_CLICK(SC_FOCUS_POLICY(*style), 1);
  FPS_RAISE_UNFOCUSED_DECOR_CLICK(SF_FOCUS_POLICY(*style), 0);
  FPS_RAISE_UNFOCUSED_DECOR_CLICK(SM_FOCUS_POLICY(*style), 1);
  FPS_RAISE_UNFOCUSED_DECOR_CLICK(SC_FOCUS_POLICY(*style), 1);
