...
#define SET_DO_SKIP_CIRCULATE(fw,x) \
          (fw)->gsfr_flags.common.do_circulate_skip = !!(x)
#define SETM_DO_SKIP_CIRCULATE(fw,x) \
          (fw)->gsfr_flag_mask.common.do_circulate_skip = !!(x)
#define DO_SKIP_ICON_CIRCULATE(fw) \
          ((fw)->gsfr_flags.common.do_circulate_skip_icon)
...
#define SET_DO_SKIP_WINDOW_LIST(fw,x) \
          (fw)->gsfr_flags.common.do_window_list_skip = !!(x)
#define SETM_DO_SKIP_WINDOW_LIST(fw,x) \
          (fw)->gsfr_flag_mask.common.do_window_list_skip = !!(x)
#define DO_START_ICONIC(fw)    ((fw)->gsfr_flags.common.do_start_iconic)
#define SET_DO_START_ICONIC(fw,x) \
          (fw)->gsfr_flags.common.do_start_iconic = !!(x)
#define SETM_DO_START_ICONIC(fw,x) \
          (fw)->gsfr_flag_mask.common.do_start_iconic = !!(x)
#define IS_ICON_STICKY(fw)     ((fw)->gsfr_flags.common.is_icon_sticky)
#define SET_ICON_STICKY(fw,x)  (fw)->gsfr_flags.common.is_icon_sticky = !!(x)
#define SETM_ICON_STICKY(fw,x) \
          (fw)->gsfr_flag_mask.common.is_icon_sticky = !!(x)
#define IS_ICON_SUPPRESSED(fw) \
          ((fw)->gsfr_flags.common.is_icon_suppressed)
#define SET_ICON_SUPPRESSED(fw,x)  \
          (fw)->gsfr_flags.common.is_icon_suppressed = !!(x)
#define SETM_ICON_SUPPRESSED(fw,x) \
          (fw)->gsfr_flag_mask.common.is_icon_suppressed = !!(x)
#define IS_LENIENT(fw)         ((fw)->gsfr_flags.common.is_lenient)
#define SET_LENIENT(fw,x)      (fw)->gsfr_flags.common.is_lenient = !!(x)
#define SETM_LENIENT(fw,x)     (fw)->gsfr_flag_mask.common.is_lenient = !!(x)
#define IS_STICKY(fw)          ((fw)->gsfr_flags.common.is_sticky)
...
#define SET_HAS_NO_ICON_TITLE(fw,x) \
          (fw)->gsfr_flags.common.has_no_icon_title = !!(x)
#define SETM_HAS_NO_ICON_TITLE(fw,x) \
          (fw)->gsfr_flag_mask.common.has_no_icon_title = !!(x)
#define HAS_MWM_BORDER(fw)     ((fw)->gsfr_flags.common.has_mwm_border)
...
#define DO_REUSE_DESTROYED(fw) ((fw)->gsfr_flags.do_reuse_destroyed)
#define SET_DO_REUSE_DESTROYED(fw,x) \
          (fw)->gsfr_flags.do_reuse_destroyed = !!(x)
#define SETM_DO_REUSE_DESTROYED(fw,x) \
          (fw)->gsfr_flag_mask.do_reuse_destroyed = !!(x)
#define HAS_BORDER(fw)         ((fw)->gsfr_flags.has_border)
#define SET_HAS_BORDER(fw,x)   (fw)->gsfr_flags.has_border = !!(x)
#define SETM_HAS_BORDER(fw,x)  (fw)->gsfr_flag_mask.has_border = !!(x)
#define HAS_TITLE(fw)          ((fw)->gsfr_flags.has_title)
#define SET_HAS_TITLE(fw,x)    (fw)->gsfr_flags.has_title = !!(x)
#define SETM_HAS_TITLE(fw,x)   (fw)->gsfr_flag_mask.has_title = !!(x)
#define IS_MAPPED(fw)          ((fw)->gsfr_flags.is_mapped)
#define SET_MAPPED(fw,x)       (fw)->gsfr_flags.is_mapped = !!(x)
#define SETM_MAPPED(fw,x)      (fw)->gsfr_flag_mask.is_mapped = !!(x)
#define IS_ICONIFIED(fw)       ((fw)->gsfr_flags.is_iconified)
#define SET_ICONIFIED(fw,x)    (fw)->gsfr_flags.is_iconified = !!(x)
#define SETM_ICONIFIED(fw,x)   (fw)->gsfr_flag_mask.is_iconified = !!(x)
#define IS_ICONIFIED_BY_PARENT(fw) \
                               ((fw)->gsfr_flags.is_iconified_by_parent)
#define SET_ICONIFIED_BY_PARENT(fw,x) \
          (fw)->gsfr_flags.is_iconified_by_parent = !!(x)
...
#define SETM_ICON_SHAPED(fw,x) (fw)->gsfr_flag_mask.is_icon_shaped = !!(x)
#define IS_ICON_MOVED(fw)      ((fw)->gsfr_flags.is_icon_moved)
#define SET_ICON_MOVED(fw,x)   (fw)->gsfr_flags.is_icon_moved = !!(x)
#define SETM_ICON_MOVED(fw,x)  (fw)->gsfr_flag_mask.is_icon_moved = !!(x)
#define IS_ICON_UNMAPPED(fw)   ((fw)->gsfr_flags.is_icon_unmapped)
#define SET_ICON_UNMAPPED(fw,x) \
                               (fw)->gsfr_flags.is_icon_unmapped = !!(x)
#define SETM_ICON_UNMAPPED(fw,x) \
                               (fw)->gsfr_flag_mask.is_icon_unmapped = !!(x)
#define IS_MAP_PENDING(fw)     ((fw)->gsfr_flags.is_map_pending)
#define SET_MAP_PENDING(fw,x)  (fw)->gsfr_flags.is_map_pending = !!(x)
#define SETM_MAP_PENDING(fw,x) (fw)->gsfr_flag_mask.is_map_pending = !!(x)
#define IS_MAXIMIZED(fw)       ((fw)->gsfr_flags.is_maximized)
#define SET_MAXIMIZED(fw,x)    (fw)->gsfr_flags.is_maximized = !!(x)
#define SETM_MAXIMIZED(fw,x)   (fw)->gsfr_flag_mask.is_maximized = !!(x)
#define IS_NAME_CHANGED(fw)    ((fw)->gsfr_flags.is_name_changed)
#define SET_NAME_CHANGED(fw,x) (fw)->gsfr_flags.is_name_changed = !!(x)
#define SETM_NAME_CHANGED(fw,x) (fw)->gsfr_flag_mask.is_name_changed = !!(x)
#define IS_PIXMAP_OURS(fw)     ((fw)->gsfr_flags.is_pixmap_ours)
#define SET_PIXMAP_OURS(fw,x)  (fw)->gsfr_flags.is_pixmap_ours = !!(x)
#define SETM_PIXMAP_OURS(fw,x) (fw)->gsfr_flag_mask.is_pixmap_ours = !!(x)
#define IS_SHADED(fw)          ((fw)->gsfr_flags.is_window_shaded)
#define SET_SHADED(fw,x)       (fw)->gsfr_flags.is_window_shaded = !!(x)
#define SETM_SHADED(fw,x)      (fw)->gsfr_flag_mask.is_window_shaded = !!(x)
#define IS_TRANSIENT(fw)       ((fw)->gsfr_flags.is_transient)
#define SET_TRANSIENT(fw,x)    (fw)->gsfr_flags.is_transient = !!(x)
#define SETM_TRANSIENT(fw,x)   (fw)->gsfr_flag_mask.is_transient = !!(x)
#define IS_VIEWPORT_MOVED(fw)  ((fw)->gsfr_flags.is_viewport_moved)
#define SET_VIEWPORT_MOVED(fw,x) \
          (fw)->gsfr_flags.is_viewport_moved = !!(x)
#define SETM_VIEWPORT_MOVED(fw,x) \
          (fw)->gsfr_flag_mask.is_viewport_moved = !!(x)
#define IS_VIEWPORT_MOVED(fw)  ((fw)->gsfr_flags.is_viewport_moved)
#define IS_VISIBLE(fw)         ((fw)->gsfr_flags.is_visible)
#define SET_VISIBLE(fw,x)      (fw)->gsfr_flags.is_visible = !!(x)
#define SETM_VISIBLE(fw,x)     (fw)->gsfr_flag_mask.is_visible = !!(x)
...
#define SET_WINDOW_BEING_MOVED_OPAQUE(fw,x) \
          (fw)->gsfr_flags.is_window_being_moved_opaque = !!(x)
#define SETM_WINDOW_BEING_MOVED_OPAQUE(fw,x) \
          (fw)->gsfr_flag_mask.is_window_being_moved_opaque = !!(x)
#define WM_DELETES_WINDOW(fw)   ((fw)->gsfr_flags.does_wm_delete_window)
#define SET_WM_DELETES_WINDOW(fw,x) \
          (fw)->gsfr_flags.does_wm_delete_window = !!(x)
#define SETM_WM_DELETES_WINDOW(fw,x) \
          (fw)->gsfr_flag_mask.does_wm_delete_window = !!(x)
#define WM_TAKES_FOCUS(fw)     ((fw)->gsfr_flags.does_wm_take_focus)
#define SET_WM_TAKES_FOCUS(fw,x) \
          (fw)->gsfr_flags.does_wm_take_focus = !!(x)
#define SETM_WM_TAKES_FOCUS(fw,x) \
          (fw)->gsfr_flag_mask.does_wm_take_focus = !!(x)
