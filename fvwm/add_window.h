...
void setup_window_font(FvwmWindow *fw, window_style *pstyle, Bool do_destroy);
void setup_icon_font(FvwmWindow *fw, window_style *pstyle, Bool do_destroy);
...
void	    GetWindowSizeHintsWithCheck(FvwmWindow *fw,
...
void	    RestoreWithdrawnLocation(FvwmWindow *tmp, Bool is_restart_or_exit,
	   Window parent);
void	    Reborder(void);
