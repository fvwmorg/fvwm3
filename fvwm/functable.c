...
const func_t func_table[] = {
 ...
 /* - Attach decor to a window (will be obsolete) */
	...
	CMD_ENT("changemenustyle", CMD_ChangeMenuStyle, F_CHANGE_MENUSTYLE, 0,
	    0),
 ...
 /* - Set virtual desktop size in units of physical pages */
	...
	CMD_ENT("destroy", CMD_Destroy, F_DESTROY, FUNC_NEEDS_WINDOW,
	    CRS_DESTROY),
 ...
 /* - Switch viewport to another page same desk */
	...
	CMD_ENT("hidegeometrywindow", CMD_HideGeometryWindow, F_HIDEGEOMWINDOW,
	    0, 0),
 ...
 /* - (obsolete, use Style * IconFont) */
	...
	CMD_ENT("iconify", CMD_Iconify, F_ICONIFY, FUNC_NEEDS_WINDOW,
	    CRS_SELECT),
 ...
 /* - (obsolete, use ImagePath instead) */
	...
	CMD_ENT("ignoremodifiers", CMD_IgnoreModifiers, F_IGNORE_MODIFIERS, 0,
	    0),
 ...
 /* - Clears all entries from the infostore */
	...
	CMD_ENT("infostoreremove", CMD_InfoStoreRemove, F_INFOSTOREREMOVE, 0,
	    0),
 ...
 /* - Lower a window within a layer */
	...
	CMD_ENT("maximize", CMD_Maximize, F_MAXIMIZE, FUNC_NEEDS_WINDOW,
	    CRS_SELECT),
 ...
 /* - Modify the directories to search for an fvwm module */
	...
	CMD_ENT("modulesynchronous", CMD_ModuleSynchronous, F_MODULE_SYNC, 0,
	    0),
 ...
 /* - Bind or unbind a mouse button press to an fvwm action */
	...
	CMD_ENT("move", CMD_Move, F_MOVE, FUNC_NEEDS_WINDOW | FUNC_IS_MOVE_TYPE,
	    CRS_MOVE),
 /* - Move a window */
 ...
 /* - Restart itself or replace with another window manager */
	...
	CMD_ENT("savequitsession", CMD_SaveQuitSession, F_SAVE_QUIT_SESSION, 0,
	    0),
 ...
 /* - Internal, used for module communication */
	...
	CMD_ENT("send_windowlist", CMD_Send_WindowList, F_SEND_WINDOW_LIST, 0,
	    0),
 /* - Internal, used for module communication */
 ...
 /* - Internal, used for module communication */
	...
	CMD_ENT("set_nograb_mask", CMD_set_nograb_mask, F_SET_NOGRAB_MASK, 0,
	    0),
 /* - Internal, used for module communication */
...
const func_t *
find_builtin_function(const char *func)
{
	static int nfuncs = 0;
	func_t	  *ret_func;
	char	  *temp;
	...
	ret_func = (func_t *)bsearch(temp, func_table, nfuncs, sizeof(func_t),
	    func_comp);
	free(temp);
