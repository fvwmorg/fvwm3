...
#define ST_ACTIVE_AREA_PERCENT(s) ((s)->feel.ActiveAreaPercent)
#define MST_ACTIVE_AREA_PERCENT(m) ((m)->s->ms->feel.ActiveAreaPercent)
...
#define ST_HOTKEY_ACTIVATES_IMMEDIATE(s) \
	((s)->feel.flags.hotkey_activates_immediate)
#define MST_HOTKEY_ACTIVATES_IMMEDIATE(m) \
	((m)->s->ms->feel.flags.hotkey_activates_immediate)
