...
[Full Changelog](https://github.com/fvwmorg/fvwm3/compare/1.0.5...HEAD)

**Fixed bugs:**

- Windows change geometry when fvwm3 starts [\#677](https://github.com/fvwmorg/fvwm3/issues/677)
- desk\_add: fix window counting [\#716](https://github.com/fvwmorg/fvwm3/pull/716) ([ThomasAdam](https://github.com/ThomasAdam))
- Fix background resetting in default-config [\#714](https://github.com/fvwmorg/fvwm3/pull/714) ([somiaj](https://github.com/somiaj))
- Rename .stalonetrayrc to stalonetrayrc [\#713](https://github.com/fvwmorg/fvwm3/pull/713) ([wfp5p](https://github.com/wfp5p))
- doc: don't install fvwm3\_manpage\_source [\#712](https://github.com/fvwmorg/fvwm3/pull/712) ([ThomasAdam](https://github.com/ThomasAdam))

**Merged pull requests:**

- changing sprintf -\> snprintf & co [\#720](https://github.com/fvwmorg/fvwm3/pull/720) ([omar-polo](https://github.com/omar-polo))
- two clock\_t and time\_t casts for portability [\#719](https://github.com/fvwmorg/fvwm3/pull/719) ([omar-polo](https://github.com/omar-polo))
- remove unused variable [\#718](https://github.com/fvwmorg/fvwm3/pull/718) ([omar-polo](https://github.com/omar-polo))
