...
Free(void *p);
extern void
ShutMeDown(int flag) __attribute__((__noreturn__));
extern RETSIGTYPE
...
int
check_resolution(WinManager *man, WinData *win);
extern WinManager *
figure_win_manager(WinData *win, Uchar mask);
extern void
init_winlists(void);
extern void
...
extern void
update_window_stuff(WinManager *man);
extern void
print_managers(void);
