...
extern void ProcessMsgPushButton(struct XObj *xobj, unsigned long type,
    unsigned long *body);
...
extern void ProcessMsgRadioButton(struct XObj *xobj, unsigned long type,
    unsigned long *body);
...
extern void ProcessMsgItemDraw(struct XObj *xobj, unsigned long type,
    unsigned long *body);
...
extern void ProcessMsgCheckBox(struct XObj *xobj, unsigned long type,
    unsigned long *body);
...
extern void ProcessMsgTextField(struct XObj *xobj, unsigned long type,
    unsigned long *body);
...
extern void ProcessMsgHScrollBar(struct XObj *xobj, unsigned long type,
    unsigned long *body);
...
extern void ProcessMsgVScrollBar(struct XObj *xobj, unsigned long type,
    unsigned long *body);
...
extern void ProcessMsgPopupMenu(struct XObj *xobj, unsigned long type,
    unsigned long *body);
...
extern void ProcessMsgRectangle(struct XObj *xobj, unsigned long type,
    unsigned long *body);
...
extern void ProcessMsgMiniScroll(struct XObj *xobj, unsigned long type,
    unsigned long *body);
...
extern void ProcessMsgSwallow(struct XObj *xobj, unsigned long type,
    unsigned long *body);
...
extern void ProcessMsgHDipstick(struct XObj *xobj, unsigned long type,
    unsigned long *body);
...
extern void ProcessMsgVDipstick(struct XObj *xobj, unsigned long type,
    unsigned long *body);
...
extern void ProcessMsgList(struct XObj *xobj, unsigned long type,
    unsigned long *body);
...
extern void ProcessMsgMenu(struct XObj *xobj, unsigned long type,
    unsigned long *body);
