...
/*    fprintf(stderr,"%s: Couldn't find app window\n",MyName); */
  ...
  mysizehints.flags=
    PAspect|
    PWinGravity|PSize|PBaseSize|PPosition;
  mysizehints.min_aspect.x=1;           /* dje */
  mysizehints.min_aspect.y=4;
  mysizehints.max_aspect.x=4;
  mysizehints.max_aspect.y=1;

  /* subtract one for the right/bottom border */
  mysizehints.width = lmax+10;
  mysizehints.height=height+1000;
  mysizehints.width_inc = 1;
  mysizehints.height_inc = 1;
  mysizehints.base_height = 0;
  mysizehints.base_width = 0;
  mysizehints.min_height = mysizehints.height-900;
  mysizehints.min_width = mysizehints.width;
  mysizehints.max_height = mysizehints.height-900;
  ...
  mysizehints.win_gravity = NorthWestGravity; /* dje */
...
#define BW 1
  ...
  XSetWMSizeHints(dpy, main_win, &mysizehints, XA_WM_ZOOM_HINTS); /* dje */
