...
struct fpmonitor *
fpmonitor_by_name(const char *);
struct fpmonitor *
fpmonitor_by_output(int);
struct fpmonitor *
...
void
list_toggle(unsigned long *body);
void
